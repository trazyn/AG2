...
define("modules/home/index",["modules/home/service","modules/photography/index","ui/slide","ui/toast","ui/validation"],function(e,t){"use strict";return function(a,i){var o=a.find(".menus li[data-index]"),s=function(){s.ticking=!0,setTimeout(function(){var e=d.attr("data-index"),t=o.filter("[data-index='"+e+"']");t.length&&(o.find(".md-link").removeClass("active"),t.find(".md-link").addClass("active")),s.ticking=!1},500)},d=a.find("section[data-index]:first");a.on("mousewheel",function(e){var t;s.ticking||(e.originalEvent.wheelDelta/120>0?(t=d.prev("section.background"),t.length&&(s(),d.removeClass("active"),d=t.removeClass("down-scroll").addClass("up-scroll"))):(t=d.next("section.background"),t.length&&(s(),d.removeClass("up-scroll active").addClass("down-scroll"),d=t)),d.addClass("active"))}).delegate(".menus li[data-index]","click",function(){var e=$(this),t=e.attr("data-index");e.parents("ul").find(".md-link").removeClass("active"),d!==t&&(d.removeClass("active"),d=a.find("section.background[data-index='"+t+"']").addClass("active"),a.find("section.background[data-index]").removeClass("up-scroll down-scroll"),d.prevAll("section.background[data-index]").removeClass("up-scroll").addClass("down-scroll"),e.find(".md-link").addClass("active"))}).delegate("form button[name=send]","click",function(e){var t=$(this).parents("form").validation();e.preventDefault(),e.stopPropagation(),"resolved"===t.validate().state()&&(i.start(),$.ajax({type:"POST",url:"service/sendFeedback",data:t.series()}).fail(function(){$.toast.top("Failed to send the feedback, please try again :(").left()}).done(function(){t.clean(),$.toast.top("Thank you for your feedback!","md-toast-lightGray").left()}).always(function(){i.done()}))}).delegate("section[data-index='photography'] a[data-type]","click",function(e){e.preventDefault(),e.stopPropagation(),t(a.find(".modal-photography"),this.getAttribute("data-type"))}).delegate("section[data-index='video-film'] a[data-type]","click",function(e){var t=$(this),a=t.attr("data-type"),i=t.parents(".row").find(".video[data-type]");e.preventDefault(),e.stopPropagation(),t.hasClass("active")||(t.addClass("active").parents("ul").find(".active").not(t).removeClass("active"),i.filter(".show").stop().fadeOut(400,function(){$(this).removeClass("show"),i.filter("[data-type='"+a+"']").stop().fadeIn(200,function(){$(this).addClass("show")})}))}).delegate(".showcase img","click",function(){var e=$(this);$.modal({showTitle:!1,class4modal:"modal-showcase",animation:"scale",closeByDocument:!0,render:function(t,a){this.html(e.clone())}})}).find(".slide:first").slide(),e.getVideo().done(function(e){var t=a.find("section[data-index='video-film']");["pre-wedding","wedding","movie","commercial","other"].forEach(function(a,i){var o=e[i]||{};t.find(".video[data-type='"+a+"']").html(o.source)})}),e.getNewest().done(function(e){for(var t="",i=0,o=e.length;o>i;++i)(0===i||i%3===0)&&(t+='<div class="row">'),t+='<div class="col-md-4"><img src="'+e[i].teaser+'" class="md-loading md-loading-show" onload="this.classList.remove(\'md-loading-show\')"></div>',(i+1)%3===0&&(t+="</div>");a.find(".showcase").html(t)}),e.getNewestPost().done(function(e){for(var t="",i=function(e,t){return e.length>t?e.substr(0,t)+"...":e},o=0,s=e.length;s>o;++o){var d=e[o];t+='<div class="row post"><div class="col-md-4"><div class="post-cover image-zoom"><img src="'+d.teaser+'" alt=""></div></div><div class="col-md-8"><div class="post-title"><a class="md-link" href="/#/post/'+d.id+'">'+d.title+'</a></div><div class="post-content">'+i(d.content,200)+'</div><div class="post-date">'+dateutil(d.create_date).format("%d %A %Y")+"</div></div></div>"}a.find(".post-list").append(t)}),e.getAbout().done(function(e){a.find(".about-content").html(unescape(e.about))})}});
